...
public class SysRole extends BaseEntity {
    ...
    /**
     * 菜单树选择项是否关联显示（ false：层级独立显示 true：层级关联显示）
     */
    private boolean menuCheckStrictly;

    /**
     * 部门树选择项是否关联显示（false：层级独立显示 true：层级关联显示 ）
     */
    ...
    /**
     * 菜单组(自身没有被选中，选中的是子集菜单)
     */
    private Long[] mistyMenuIds;
    ...
    public Long[] getMistyMenuIds() {
        return mistyMenuIds;
    }

    public void setMistyMenuIds(Long[] mistyMenuIds) {
        this.mistyMenuIds = mistyMenuIds;
    }
