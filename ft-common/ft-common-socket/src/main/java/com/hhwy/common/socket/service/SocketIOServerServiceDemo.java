...
@Slf4j
//@Service
public class SocketIOServerServiceDemo implements ISocketIOServerService {
        ...
        new Thread(() -> {
            while (true) {
                try {
                    ...
                    socketIOServer.getBroadcastOperations().sendEvent("myBroadcast_client", "广播消息 " + System.currentTimeMillis());
