package com.hhwy.common.log.aspect;
...
import com.hhwy.common.log.enums.BusinessStatus;
import com.hhwy.common.log.service.AsyncLogService;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.hhwy.common.log.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            if (StringUtils.isNotBlank(tenantKey)) {
                operLog.setTenantKey(tenantKey);
            }
