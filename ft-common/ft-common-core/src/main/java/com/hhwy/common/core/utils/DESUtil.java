...
public class DESUtil {
    ...
    private static final String key = "xFxqFAgMBAAECgYBgUGaFO7ae5ka0ENJw2lIwXKfvhJNmuDpw5FuJ9+Q6L";
    ...
    public static void main(String[] args) {
        String encrypt = encrypt("testestPWDtestPWDtPWD", "admin");
        System.err.println(encrypt);
        String decrypt = decrypt("testestPWDtestPWDtPWD", encrypt);
