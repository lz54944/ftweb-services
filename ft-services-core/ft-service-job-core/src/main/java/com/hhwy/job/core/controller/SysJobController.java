package com.hhwy.job.core.controller;

import com.hhwy.common.core.exception.job.TaskException;
...
import com.hhwy.job.core.domain.SysJob;
import com.hhwy.job.core.service.ISysJobService;
import com.hhwy.job.core.util.CronUtils;
...
public class SysJobController extends BaseController {
    ...
    public AjaxResult add(@RequestBody SysJob sysJob) throws SchedulerException, TaskException {
        ...
        sysJob.setCreateUser(SecurityUtils.getUserName());
    ...
    public AjaxResult edit(@RequestBody SysJob sysJob) throws SchedulerException, TaskException {
        ...
        sysJob.setUpdateUser(SecurityUtils.getUserName());
