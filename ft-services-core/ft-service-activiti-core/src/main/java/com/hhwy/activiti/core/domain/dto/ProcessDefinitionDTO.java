...
/**
 * <br>描 述： ProcessDefinitionDTO
 * <br>创 建 人：Jinzhaoqiang
 * <br>创建时间：2021/7/12 16:36
 * <br>修改备注：无
 * <br>版本：1.0.0
 */
public class ProcessDefinitionDTO extends BaseEntity implements Comparable<ProcessDefinitionDTO> {
    ...
    @Override
    public int compareTo(ProcessDefinitionDTO processDefinitionDTO) {
        int i = processDefinitionDTO.getKey().compareTo(this.key);
        int j = processDefinitionDTO.getVersion()-this.version;
        if(i!=0){
            return i;
        }else {
            return j;
